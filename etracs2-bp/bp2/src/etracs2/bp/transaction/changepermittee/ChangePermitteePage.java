/*
 * ChangePermitteePage.java
 *
 * Created on June 6, 2011, 5:36 PM
 */

package etracs2.bp.transaction.changepermittee;
...
public class ChangePermitteePage extends javax.swing.JPanel {
    
    /**
     * Creates new form ChangePermitteePage
     */
    public ChangePermitteePage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xLabel5.setCaption("Prev. Owner Name");
        ...
        xLabel6.setCaption("Prev. Owner Address");
        ...
        xActionTextField1.setActionName("lookupOwner");
        xActionTextField1.setCaption("New Owner Name");
        xActionTextField1.setCaptionWidth(120);
        xActionTextField1.setName("entity.info.newtaxpayername");
        ...
        xLabel9.setCaption("New Owner Addess");
        xLabel9.setCaptionWidth(120);
        xLabel9.setExpression("#{entity.info.newtaxpayeraddress}");
