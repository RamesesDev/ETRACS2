 ...
 * @author  jzamora
 */
public class SummaryConditionPage extends javax.swing.JPanel {
    
    /** Creates new form RuleConditionPage */
    public SummaryConditionPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xTitledBorder1.setTitle("Summary Account Condition");
        jPanel1.setBorder(xTitledBorder1);
        xList1.setDynamic(true);
        xList1.setExpression("#{name}");
        xList1.setItems("condition.summaries");
        ...
        jLabel1.setText("Summary Account is any of the following :");
