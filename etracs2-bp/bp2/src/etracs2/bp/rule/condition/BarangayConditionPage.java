 ...
 * @author  jzamora
 */
public class BarangayConditionPage extends javax.swing.JPanel {
    
    /** Creates new form RuleConditionPage */
    public BarangayConditionPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(372, 394));
        com.rameses.rcp.control.border.XTitledBorder xTitledBorder1 = new com.rameses.rcp.control.border.XTitledBorder();
        xTitledBorder1.setTitle("Barangay Condition");
        jPanel1.setBorder(xTitledBorder1);
        xList1.setDynamic(true);
        xList1.setExpression("#{name}");
        xList1.setItems("condition.barangays");
        ...
        jLabel1.setText("Barangay is any of the following :");
