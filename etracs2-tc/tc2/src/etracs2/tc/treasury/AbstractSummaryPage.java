 ...
 * @author  jzamora
 */
public class AbstractSummaryPage extends javax.swing.JPanel {
    
    /** Creates new form CollectionSummaryPage */
    public AbstractSummaryPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xTitledBorder1.setTitle("Abstract of Collection");
        jPanel2.setBorder(xTitledBorder1);
        jPanel5.setLayout(new java.awt.BorderLayout());

        xDataTable2.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 10, 1, 1));
        xDataTable2.setDepends(new String[] {"charttype"});
        xDataTable2.setDynamic(true);
        xDataTable2.setHandler("summaryListHandler");
        xDataTable2.setImmediate(true);
        xDataTable2.setName("selectedSummary");
        xDataTable2.setPreferredSize(new java.awt.Dimension(500, 150));
