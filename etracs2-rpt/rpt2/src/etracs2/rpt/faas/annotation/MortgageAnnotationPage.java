...
public class MortgageAnnotationPage extends javax.swing.JPanel {
    
    /** Creates new form MortgageAnnotationPage */
    public MortgageAnnotationPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xTitledBorder1.setTitle("Mortgage Annotation Information");
        ...
        xTextField2.setName("entity.bank");
        xTextField2.setPreferredSize(new java.awt.Dimension(0, 19));
        xTextField2.setRequired(true);
        formPanel4.add(xTextField2);

        xDateField1.setCaption("Mortgage Date");
        xDateField1.setCaptionWidth(110);
        xDateField1.setName("entity.mortgagedate");
