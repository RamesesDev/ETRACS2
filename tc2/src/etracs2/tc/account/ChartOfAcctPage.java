...
public class ChartOfAcctPage extends javax.swing.JPanel {
    
    /** Creates new form AccountPage */
    public ChartOfAcctPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xTitledBorder1.setTitle("Chart of Account Information");
        formPanel1.setBorder(xTitledBorder1);
        xLabel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        xLabel1.setCaption("Chart Type");
        xLabel1.setCaptionWidth(80);
        xLabel1.setFont(new java.awt.Font("Tahoma", 1, 11));
        xLabel1.setName("account.charttype");
        ...
        xTextField1.setName("account.code");
        ...
        xTextField2.setName("account.title");
        xTextField2.setPreferredSize(new java.awt.Dimension(0, 19));
        xTextField2.setRequired(true);
        formPanel1.add(xTextField2);

        jPanel1.add(formPanel1);
        formPanel1.setBounds(5, 0, 436, 164);
